...
//     try {
//       const response = await fetch(`http://localhost/game/create/${websocket_obj.username}/${websocket_obj.invited_id}`);
...
// }
  ...
  //     const response = await fetch(`http://localhost/game/render/invites/${username}/`);
